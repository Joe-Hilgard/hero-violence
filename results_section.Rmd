...
ANOVA indicated a significant effect of game, F(2, 183) = 3.20, p = .043. Neither the effect of request nor the Game × Request interaction was statistically significant, F(1, 183) = 1.27, p = .262 and F(2, 183) = 0.00, p = .996, respectively.  
